...
class CreateMusicPlaylistWidget extends ConsumerStatefulWidget {
  const CreateMusicPlaylistWidget({super.key});

  @override
  ConsumerState<CreateMusicPlaylistWidget> createState() =>
      _CreateMusicPlaylistWidgetState();
}

class _CreateMusicPlaylistWidgetState
    extends ConsumerState<CreateMusicPlaylistWidget> {
  final playlistName = TextEditingController(
    text: 'My Music Playlist #1',
  );
  final playlistDescription = TextEditingController();

  final FocusNode _focusNode = FocusNode();

  List<String> predefinedHashtags = ["#Chill", "#Workout", "#SummerVibes"];
