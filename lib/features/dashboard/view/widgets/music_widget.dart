...
import 'package:mingalar_music_app/features/dashboard/view/widgets/recent_playlist_widget.dart';
...
class MusicWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ref.watch(getAllMusicProvider).when(
          data: (music) {
